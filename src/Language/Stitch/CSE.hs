...
newtype ShiftedExp base_ctx :: forall n. Ctx n -> Type -> Type where
...
data Lets :: forall n. (forall m. Ctx m -> Type -> Type) -> Ctx n -> Type where
...
shiftMap :: forall (a :: forall n. Ctx n -> Type -> Type)
                   (b :: forall n. Ctx n -> Type -> Type)
                   ctx ty.
...
unshiftSet :: forall (a :: forall n. Ctx n -> Type -> Type) ty ctx.
